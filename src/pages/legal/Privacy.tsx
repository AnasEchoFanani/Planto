    ...
    <div className="min-h-screen px-4 py-24 text-white">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="mb-6 text-lg">
          At <strong>Nexus</strong>, we value your privacy and are committed to
        ...
        <h2 className="text-3xl font-semibold mt-6 mb-4">Data Security</h2>
        <p className="mb-4">
          We take the security of your personal information seriously. We
          implement a variety of security measures to protect your data from
